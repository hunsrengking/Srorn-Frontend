...
const TicketCheckerView = lazy(() => import("@/views/setting/checker/CheckerView"));
...
const DepartmentList = lazy(() => import("@/views/setting/department/Department"));
const DepartmentCreate = lazy(() => import("@/views/setting/department/CreateDepartment"));
const DepartmentMember = lazy(() => import("@/views/setting/department/DepartmentMember"));
...
const PrintCardNew = lazy(() => import("@/views/organization/card/PrintCardNew"));
const PrintCardView = lazy(() => import("@/views/organization/card/PrintCardView"));
const PrintCardEdit = lazy(() => import("@/views/organization/card/PrintCardEdit"));
...
export const protectedRoutes = [
  ...
  { path: "ticket/create", permission: "CREATE_TICKET", element: <CreateTicket /> },
  { path: "ticket/views/:id", permission: "VIEW_TICKET", element: <ViewTicket /> },
  { path: "checkermaker", permission: "MAKER_CHECKER", element: <TicketChecker /> },
  { path: "checkermaker/view/:id", permission: "MAKER_CHECKER", element: <TicketCheckerView /> },
  ...
  { path: "settings/roles/create", permission: "CREATE_ROLES", element: <RoleCreate /> },
  {
    path: "settings/roles/:id/permissions",
    permission: "UPDATE_PERMISSIONS",
    element: <RolePermission />,
  },
  { path: "settings/departments", permission: "VIEW_DEPARTMENT", element: <DepartmentList /> },
  {
  ...
  { path: "settings/employees/:id/view", permission: "VIEW_STAFF", element: <StaffView /> },

  { path: "reports/summary", permission: "VIEW_REPORTS", element: <Report /> },

  { path: "organization", permission: "VIEW_ORGANIZATION", element: <Organization /> },
  { path: "organization/office", permission: "VIEW_OFFICE", element: <Office /> },
  { path: "organization/office/create", permission: "CREATE_OFFICE", element: <OfficeCreate /> },
  { path: "organization/office/:id/edit", permission: "UPDATE_OFFICE", element: <OfficeEdit /> },
  { path: "organization/office/:id/view", permission: "VIEW_OFFICE", element: <OfficeView /> },
  { path: "organization/printcard", permission: "VIEW_ORGANIZATION", element: <PrintCard /> },
  {
    path: "organization/printcard/newcard",
    permission: "VIEW_ORGANIZATION",
    element: <PrintCardNew />,
  },
  { path: "organization/printcard/:id", permission: "VIEW_ORGANIZATION", element: <PrintCardView /> },
  {
  ...
  { path: "inventory/product", permission: "MANAGE_PRODUCT", element: <Product /> },
  { path: "inventory/product/create", permission: "MANAGE_PRODUCT", element: <ProductCreate /> },
  { path: "inventory/product/:id/edit", permission: "MANAGE_PRODUCT", element: <ProductEdit /> },
  { path: "inventory/stock", permission: "MANAGE_STOCK", element: <Stock /> },
  { path: "inventory/stock/adjust", permission: "MANAGE_STOCK", element: <StockAdjust /> },
  { path: "inventory/asset", permission: "MANAGE_STOCK", element: <Asset /> },
  { path: "inventory/asset/create", permission: "MANAGE_STOCK", element: <AssetCreate /> },
  { path: "inventory/asset/:id/edit", permission: "MANAGE_STOCK", element: <AssetEdit /> },
  { path: "inventory/asset/:id/view", permission: "MANAGE_STOCK", element: <AssetView /> },
];
